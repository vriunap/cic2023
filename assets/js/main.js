$(function() {
    ...
    function makeTimer($endDate, $this, $format) {
        ...
        var yearsLeft = yearsLeft < 10 ? "0" + yearsLeft : yearsLeft,
          ...
          daysText = daysLeft > 1 ? 'Dias' : 'day',
          hourText = hrsLeft > 1 ? 'Horas' : 'Hr',
          minsText = minsLeft > 1 ? 'Minutos' : 'min',
          secText = secsLeft > 1 ? 'Segundos' : 'sec';
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
  anchor.addEventListener('click', function (e) {
      ...
      let offsetTop = document.querySelector(this.getAttribute('href')).offsetTop;
      let offset = 100; // Altura del menú fijo
...
//       // Eliminar la clase 'active-menu' de todos los elementos <li>
//       document.querySelectorAll('.main-menu li').forEach(li => {
//           li.classList.remove('active-menu');
//       });

//       // Añadir la clase 'active-menu' al elemento <li> padre del enlace clickeado
//       this.parentNode.classList.add('active-menu');
//   });
// });
...
//       // Buscar el enlace que corresponde al anclaje y añadir la clase 'active-menu' a su elemento <li> padre
...
document.querySelectorAll('.menu-link').forEach(link => {
  link.addEventListener('click', function() {
      updateActiveMenu(this.getAttribute('href'));
  });
});
